...
$suppliers = [
    ...
    ["Maru Ehitus AS","Construction","Estonia"],
    ["Rudus AS","Construction","Estonia"],
    ["Wiima Logistics","Transportation, logistics and storage","Estonia"],
    ["Instabalt Latvia (Company's Wago representative)","Construction","Latvia"],
    ["TALGO","Manufacturing, production industry","Spain"],
    ["Vlavi Serviss LTD","Wholesale and retail trade","Latvia"],
    ["DNB banka AS","Finance and insurance","Latvia"],
    ["World Acoustic Group S.A.","Architecture and design","Poland"],
    ["Civitta International","Consulting","Estonia"],
    ["Sweco","Consulting","Estonia"],
    ["Fugro Baltic","Consulting","Lithuania"],
    ["CH2M","Consulting","United Kingdom"],
    ["REIB OÜ","Consulting","Estonia"],
];
