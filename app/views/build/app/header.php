<header class="top-header">
    <nav class="main-navigation">
        <ul>
            ...
            <li><a data-id="venue" class="venue" href="<?= URL::to('venue');?>">Venue</a></li>
...
<!--            <li><a data-id="contacts" class="contacts" href="--><?//= URL::to('contacts');?><!--">Contacts</a></li>-->
            <li><a data-id="organizer" class="organizer" href="<?= URL::to('organizer');?>">Organizer</a></li>
        </ul>
    </nav>
</header>