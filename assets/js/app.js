...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	    ...
	    $(document).on('click', '.jump-button', function (event) {
	        ...
	        var el = $(this);
	        $('.main-navigation a').removeClass('active');
	        var regExp = new RegExp('(https?:)?' + BASE_URL);
	        var cl = el.prop('href').replace(regExp, '');
	        var navClass = '.' + cl;
	    ...
	    $(".form-2-jump").click(function (event) {
	        event.preventDefault();
	        var b = $('.registration').find('.buttons a');
	    ...
	    select.each(function () {
	        ...
	        var text = $this.children('option').eq(0).text();
	    ...
	    $('#register-form1').click(function (event) {
	        ...
	        if (validFormData(form1)) {
	            ...
	            var data = form1.find('form').serializeArray();
	    ...
	    $('#register-form2').click(function (event) {
	        ...
	        if (validFormData(form2)) {
	            $(this).addClass('loading');
	            var data = form2.find('form').serializeArray();
	    ...
	    $('#register-form3').click(function (event) {
	        ...
	        if (validFormData(form3)) {
	            $(this).addClass('loading');
	            var data = form3.find('form').serializeArray();
	    ...
	    $('#register-form4').click(function (event) {
	        ...
	        if (validFormData(form4)) {
	            $(this).addClass('loading');
	            var data = form4.find('form').serializeArray();
	    ...
	    $('.speaker').click(function (event) {
	        ...
	        var position = el.find('.position').text();
	        var img = el.data('img');
	        var about = $('.a-description.a' + el.data('id')).html();
	    ...
	    $('#suppliers_search_type').change(function () {
	        ...
	        var industry = $('.industry-selector');
	        if (type === 'alphabet') {
	            alphabet.show();
	            industry.hide();
	            getSuppliers({
	...
	function elIsValid(el) {
	    var validated = true;
	    if (el.data('validate')) {
	        var validate = el.data('validate').split('|');
	        var val = $.trim(el.val());
