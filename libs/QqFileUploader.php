...
class QqFileUploader {
    ...
    public function handleUpload($uploadDirectory, $name = null){
        ...
        if (!is_writable($uploadDirectory)){
            return array('error' => "Server error. Uploads directory isn't writable or executable.", 'is_writable' => is_writable($uploadDirectory), 'is_executable' => is_executable($uploadDirectory));
        }

        if(!isset($_SERVER['CONTENT_TYPE']) && isset($_SERVER['HTTP_CONTENT_TYPE'])) { //hack for php -S
